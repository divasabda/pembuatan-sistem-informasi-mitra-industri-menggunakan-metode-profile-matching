    ...
    <section class="content">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Update Sub Aspek</h3>
        </div>
      
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <form action="<?php echo base_url('admin/pm/sub_aspek/update_sub')?>" method="post">
                <div class="col-md-6 col-lg-offset-3">

                  <div class="form-group">
                    <label for="id_aspek">Id Sub Aspek</label>
                    <input type="text" value="<?php echo $id_sub ?>" readonly="readonly" class="form-control" id="id_sub" name="id_sub">
                  </div>

                  <div class="form-group">
                    <label for="level">Aspek</label>
                    <div class="input-group">
                          <input type="text" id="id_aspek" name="id_aspek" class="form-control" readonly="" required="" value="<?php echo $id_aspek ?>" placeholder="ID Proyek">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_sub" name="nama_sub" value="<?php echo $nama_sub ?>" placeholder="Nama Sub Aspek">
                  </div>
                  <small class="form text text-danger"><?php echo form_error('nama_sub');?></small>
              
                  <div class="form-group">
                    <label for="user">Nilai Ideal</label>
                    <input type="number" class="form-control" id="nilai_ideal" name="nilai_ideal" value="<?php echo $nilai_ideal ?>" placeholder="Nilai Ideal">
                  </div>
    ...
    <div class="modal fade" id="modal-aspek">
          ...
          <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td id="idaspek" data-kode="<?php echo $row->id_aspek;?>">
                    <?php echo $row->nilai_cf;?>
                  </td>
                  <td id="idaspek" data-kode="<?php echo $row->id_aspek;?>">
                    <?php echo $row->nilai_sf;?>
                  </td>
                </tr>
                <?php endforeach; ?>
              </table>
