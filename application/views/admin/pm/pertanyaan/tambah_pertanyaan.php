  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="row">
            <form action="<?php echo base_url('admin/pm/pertanyaan/tambah_pertanyaan')?>" method="post">
                <div class="col-md-6 col-lg-offset-3">

                  <div class="form-group">
                    <label for="id_pertanyaan">ID Pertanyaan</label>
                    <input type="text" value="<?php echo $kode_pertanyaan ?>" readonly="readonly" class="form-control" id="id_pertanyaan" name="id_pertanyaan">
                  </div>

                  <div class="form-group">
                    <label>Sub Aspek</label>
                    <div class="input-group">
                          <input type="text" id="id_sub" name="id_sub" class="form-control" readonly="" required="" value="<?php echo set_value('id_sub') ?>" placeholder="ID Sub Aspek">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_pertanyaan" name="nama_pertanyaan" value="<?php echo set_value('nama_pertanyaan') ?>" placeholder="Masukkan Pertanyaan">
                  </div>
