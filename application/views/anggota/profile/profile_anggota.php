...
<?php $this->load->view('anggota/template/leftbar');?>
  ...
  <div class="content-wrapper">
    ...
    <div class="flash-upload" data-flashdata="<?php echo $this->session->flashdata('upload');?>">
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <!-- <img class="profile-user-img img-responsive img-circle" src="../../dist/img/user4-128x128.jpg" alt="User profile anggotature"> -->
        ...
        <!-- /.col -->
                <div class="col-md-9">
                  <a href="<?= base_url('anggota/profile/uploadprofile')?>" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span>
                        Upload Profile Perusahaan
                  </a>
                  <a href="<?= base_url('anggota/profile/save_password')?>" class="btn btn-danger pull-right"><span class="glyphicon glyphicon-lock"></span>
                        Ganti Password
                  </a>
