  ...
  <div class="content-wrapper">
    ...
    <!--   
      <div class="flash-user" data-flashdata="<?php echo $this->session->flashdata('user');?>">
        ...
        <div class="box-body">
          <div class="row">
            <form action="<?php echo base_url('pic/d_rab/tambahDetail')?>" method="post">
                <div class="col-md-6 col-lg-offset-3">

                  <div class="form-group">
                    <label for="nama">ID Detail</label>
                    <input type="text" value="<?php echo $kode ?>" readonly="readonly" class="form-control" id="id_d_rab" name="id_d_rab">
                  </div>

                  <div class="form-group">
                    <label for="level">ID RAB</label>
                    <div class="input-group">
                          <input type="text" id="id_rab" name="id_rab" class="form-control" readonly="" required="" value="<?php echo set_value('id_rab') ?>" placeholder="ID RAB">
                          <div class="input-group-btn">
                            <button type="button" class="btn btn-success lihat-detail" data-target="#modal-detail" >Lihat</button>
                          </div>
                      </div>
                  </div>
                  <small class="form text text-danger"><?php echo form_error('id_rab');?></small>

                  <div class="form-group">
                    <label for="nama">Nama Detail</label>
                    <input type="text" class="form-control" id="nama_detail" name="nama_detail" value="<?php echo set_value('nama_detail') ?>" placeholder="Nama Detail">
                  </div>
                  <small class="form text text-danger"><?php echo form_error('nama_detail');?></small>
              

                  <div class="form-group">
                    <label for="user">Dana Detail</label>
                    <input type="number" class="form-control uang" id="dana_detail" name="dana_detail" value="<?php echo set_value('dana_detail') ?>" placeholder="Dana Detail">
                  </div>
                  <small class="form text text-danger"><?php echo form_error('dana_detail');?></small>
