...
<div class="flash-error_dana_rab" data-flashdata="<?php echo $this->session->flashdata('dana_error');?>">

        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <form action="<?php echo base_url('pic/rab/tambah_rab')?>" method="post">
                <div class="col-md-6 col-lg-offset-3">

                  <div class="form-group">
                    <label for="nama">ID RAB</label>
                    <input type="text" value="<?php echo $kode ?>" readonly="readonly" class="form-control" id="id_rab" name="id_rab">
                  </div>

                  <div class="form-group">
                    <label for="level">ID Proyek</label>
                    <div class="input-group">
                          <input type="text" id="id_proyek" name="id_proyek" class="form-control" readonly="" required="" value="<?php echo set_value('id_proyek') ?>" placeholder="ID Proyek">
                          <div class="input-group-btn">
                            <button type="button" class="btn btn-success lihat-proyek" data-target="#modal-proyek" >Lihat</button>
                          </div>
                      </div>
                  </div>
                  <small class="form text text-danger"><?php echo form_error('id_proyek');?></small>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_rab" name="nama_rab" value="<?php echo set_value('nama_rab') ?>" placeholder="Nama RAB">
                  </div>
                  <small class="form text text-danger"><?php echo form_error('nama_rab');?></small>
              

                  <div class="form-group">
                    <label for="user">Dana RAB</label>
                    <input type="number" class="form-control" id="dana_rab" name="dana_rab" value="<?php echo set_value('dana_rab') ?>" placeholder="Dana RAB">
                  </div>
                  <small class="form text text-danger"><?php echo form_error('dana_rab');?></small>
